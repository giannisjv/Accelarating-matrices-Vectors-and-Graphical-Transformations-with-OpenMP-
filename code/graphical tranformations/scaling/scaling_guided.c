...
srand(time(NULL));
   ...
   //{
    ...
    start = omp_get_wtime();
    // filing A matrix  
    scaling_filling_guided(A, N, axisx, axisy, min, max);
    /*
    #pragma omp single
    {
    ...
    */
    ...
    scaling_cleaning_guided(A, temp, N, axisx, axisy);
    /*
    #pragma omp single
    {
    ...
    */
    ...
    scaling_guided(temp, temp2, N, scalingRow, scalingColumn);
   /*
    #pragma omp single
    {
    ...
    */
    scaling_translate_guided(temp2, B, N, axisx, axisy, scalingRow, scalingColumn);
   /* #pragma omp single
    {
