...
int main(int argc, char const *argv[]) {
  ...
  printf("\nInsert First Matrix's Number of Columns:  ");
  scanf("%d",&MA);
/* Inserting the second Matrix */
  NB = MA;
  printf("\nTaking automaticly Rows for B: %d\n",NB );
...
if(!C){
    ...
    printf("\nCan you see me here 2???\n" );
      ...
      /* -----------------------------------
             | print statements for the Matrixs |
             ----------------------------------- */
